/* 介绍一些新的语法糖，它可以优化你的 JavaScript 代码，使代码更简洁。
下面是一份 JavaScript 语法糖列表，你需要了解一下。
 */
...
// Array for each variable   .forEach()方法
...
console.log(data); 
//output testfunction callMe(val) {
//     console.log(val);
// }
// Shorthand
function checkReturn() {
...
// 21. 跟多行文本有关的缩写法
// 当我们在代码中处理多行文本时，可以使用这样的技巧   使用反引号 ` ` 包裹
//longhand
...
// 26. 查询条件缩写法
// 如果我们要检查类型，并根据类型调用不同的函数，我们既可以使用多个 else if 语句，
// 也可以使用 switch，除此之外，如果有缩写法，代码会是怎么样呢？
// Longhand
if (type === 'test1') {
  test1();
}
